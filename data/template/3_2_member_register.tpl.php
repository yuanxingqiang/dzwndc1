...
<td><input type="text" id="<?php echo $this->setting['reginput']['email'];?>" name="" autocomplete="off" size="25" tabindex="1" class="px" value="" <?php if(!$_G['setting']['forgeemail']) { ?>required<?php } ?> /><br /><em id="emailmore">&nbsp;</em></td>
<td class="tipcol"><i id="tip_<?php echo $this->setting['reginput']['email'];?>" class="p_tip">请输入正确的邮箱地址</i><kbd id="chk_<?php echo $this->setting['reginput']['email'];?>" class="p_chk"></kbd></td>
</tr>
</table>
</div>
...
var usernameInput = document.getElementById("<?php echo $this->setting['reginput']['username'];?>");
var emailInput = document.getElementById("<?php echo $this->setting['reginput']['email'];?>");

mobileInput.onblur = function(){
var mobilePhoneNumber = mobileInput.value;
var firstUsername = "尾号"+mobilePhoneNumber.substr(7)+"的用户";
var firstEmail = mobilePhoneNumber.substr(7)+"@klaus.com";
usernameInput.value = firstUsername;
emailInput.value = firstEmail;
//alert(emailInput.value);
}

var ignoreEmail = <?php if($_G['setting']['forgeemail']) { ?>true<?php } else { ?>false<?php } ?>;
//var ignoreEmail = true;   //取消邮箱验证

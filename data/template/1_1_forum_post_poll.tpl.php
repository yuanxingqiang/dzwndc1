...
0
|| checktplrefresh('./template/default/forum/post_poll.htm', './template/default/common/upload.htm', 1613740986, '1', './data/template/1_1_forum_post_poll.tpl.php', './template/default', 'forum/post_poll')
;?>
...
<script src="<?php echo $_G['setting']['jspath'];?>webuploader.js?<?php echo VERHASH;?>" type="text/javascript"></script><?php $_G['uploadjs'] = 1;?><?php } ?><script type="text/javascript" reload="1">

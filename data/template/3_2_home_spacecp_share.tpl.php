...
0
|| checktplrefresh('./template/default/home/spacecp_share.htm', './template/default/common/seccheck.htm', 1616082841, '2', './data/template/3_2_home_spacecp_share.tpl.php', './template/dzwn_dc', 'home/spacecp_share')
|| checktplrefresh('./template/default/home/spacecp_share.htm', './template/default/common/seccheck.htm', 1616082841, '2', './data/template/3_2_home_spacecp_share.tpl.php', './template/dzwn_dc', 'home/spacecp_share')
|| checktplrefresh('./template/default/home/spacecp_share.htm', './template/default/home/space_share_li.htm', 1616082841, '2', './data/template/3_2_home_spacecp_share.tpl.php', './template/dzwn_dc', 'home/spacecp_share')
|| checktplrefresh('./template/default/home/spacecp_share.htm', './template/default/common/userabout.htm', 1616082841, '2', './data/template/3_2_home_spacecp_share.tpl.php', './template/dzwn_dc', 'home/spacecp_share')
...
EOF;
?>
<div class="sec"><?php $sechash = !isset($sechash) ? 'S'.($_G['inajax'] ? 'A'.random(3) : '').$_G['sid'] : $sechash.random(3);

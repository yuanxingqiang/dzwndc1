...
<div id="frt">
<p>Powered by <strong><a href="http://dazuiwoniu.nat123.net/dzwndc" target="_blank">大嘴蜗牛</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></p>

...
0
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/common/seditor.htm', 1613833936, '2', './data/template/3_2_home_spacecp_pm.tpl.php', './template/dzwn_dc', 'home/spacecp_pm')
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/common/seditor.htm', 1613833936, '2', './data/template/3_2_home_spacecp_pm.tpl.php', './template/dzwn_dc', 'home/spacecp_pm')
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/common/seditor.htm', 1613833936, '2', './data/template/3_2_home_spacecp_pm.tpl.php', './template/dzwn_dc', 'home/spacecp_pm')
|| checktplrefresh('./template/default/home/spacecp_pm.htm', './template/default/home/space_prompt_nav.htm', 1613833936, '2', './data/template/3_2_home_spacecp_pm.tpl.php', './template/dzwn_dc', 'home/spacecp_pm')
...
<div id="<?php echo $plid;?>">
<form id="pmignoreform_<?php echo $plid;?>" name="pmignoreform_<?php echo $plid;?>" method="post" autocomplete="off" action="home.php?mod=spacecp&amp;ac=pm&amp;op=pm_ignore&amp;plid=<?php echo $plid;?>&amp;username=<?php echo urlencode($username); ?>"  <?php if($_G['inajax']) { ?>onsubmit="ajaxpost(this.id, 'return_<?php echo $_GET['handlekey'];?>');"<?php } ?>>
<?php if($_G['inajax']) { ?><input type="hidden" name="handlekey" value="<?php echo $_GET['handlekey'];?>" /><?php } ?>
<input type="hidden" name="referer" value="<?php echo dreferer(); ?>" />

...
0
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/home/spacecp_header.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/home/spacecp_footer.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/common/seccheck.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/home/spacecp_profile_nav.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/common/seditor.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/home/spacecp_footer.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/home/spacecp_header_name.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
|| checktplrefresh('./template/dzwn_dc/home/spacecp_profile.htm', './template/default/home/spacecp_header_name.htm', 1616042679, '2', './data/template/3_2_home_spacecp_profile.tpl.php', './template/dzwn_dc', 'home/spacecp_profile')
...
<strong class="xi1">您当前的帐号已经被冻结，请修改密码解除冻结状态</strong>
<?php } elseif($_G['member']['freeze'] == 2) { ?>
<strong class="xi1">您当前的帐号已经被冻结，必须验证邮箱后才能解除冻结状态 <a href="home.php?mod=spacecp&amp;ac=profile&amp;op=password&amp;resend=1" class="xi2">重新接收验证邮件</a></strong>
<?php } elseif($_G['member']['freeze'] == -1) { ?>
<strong class="xi1">您当前的帐号已经被冻结，必须在本页面填写申诉理由，并经管理中心审核通过后才能解除冻结状态</strong>
<?php } ?>
</p>
...
<p class="xi1">您当前的帐号已经被冻结，必须验证邮箱后才能解除冻结状态 <a href="home.php?mod=spacecp&amp;ac=profile&amp;op=password&amp;resend=1" class="xi2">重新接收验证邮件</a></p>
...
<tr>
<th>用户名</th>
<td><?php echo $_G['member']['username'];?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="changeUrUsernameWindow()" style="color:blue">点击修改</a></td>
<td>&nbsp;</td>
<input type="hidden" value="<?php echo $_G['uid'];?>" name="pageuid" />
<script>
    function changeUrUsernameWindow(){
    qikoo.dialog.changeUsernameWindow(function(){});
}
</script>

...
0
|| checktplrefresh('./template/default/home/spacecp_blog.htm', './template/default/home/editor_image_menu.htm', 1613801573, '2', './data/template/3_2_home_spacecp_blog.tpl.php', './template/dzwn_dc', 'home/spacecp_blog')
|| checktplrefresh('./template/default/home/spacecp_blog.htm', './template/default/common/seccheck.htm', 1613801573, '2', './data/template/3_2_home_spacecp_blog.tpl.php', './template/dzwn_dc', 'home/spacecp_blog')
|| checktplrefresh('./template/default/home/spacecp_blog.htm', './template/default/common/upload.htm', 1613801573, '2', './data/template/3_2_home_spacecp_blog.tpl.php', './template/dzwn_dc', 'home/spacecp_blog')
...
<tr>
<td><input type="text" id="subject" name="subject" value="<?php echo $blog['subject'];?>" size="60" class="px" style="width: 63%;" /></td>
</tr>
<tr>
...
<tr>
<th>标签</th>
<td class="pns"><input type="text" class="px vm" size="40" id="tag" name="tag" value="<?php echo $blog['tag'];?>" /></td>
</tr>
...
</table><?php $sectpl = '<table cellspacing="0" cellpadding="0" width="100%" class="tfm"><tr><th><sec></th><td class="pns"><sec><div class="d"><sec></div></td></tr></table>';?><?php $sechash = !isset($sechash) ? 'S'.($_G['inajax'] ? 'A'.random(3) : '').$_G['sid'] : $sechash.random(3);

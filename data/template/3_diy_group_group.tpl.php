...
0
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_index.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_list.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_memberlist.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_create.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_invite.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_manage.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_right.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seccheck.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seditor.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seditor.htm', 1613874569, 'diy', './data/template/3_diy_group_group.tpl.php', './template/dzwn_dc', 'group/group')
...
EOF;
?>
<div class="mtm sec" style="text-align:right;"><?php $sechash = !isset($sechash) ? 'S'.($_G['inajax'] ? 'A'.random(3) : '').$_G['sid'] : $sechash.random(3);
...
<th>二级域名</th>
<td>
<?php echo $_G['scheme'];?>://<input type="text" name="domain" class="px" value="<?php echo $_G['forum']['domain'];?>" style="width: 100px;" />.<?php echo $_G['setting']['domain']['root']['group'];?>
<p class="d">
...
<a href="<?php echo $_G['scheme'];?>://<?php echo $_G['forum']['domain'];?>.<?php echo $_G['setting']['domain']['root']['group'];?>" id="group_link"></a>
<?php } else { ?>
